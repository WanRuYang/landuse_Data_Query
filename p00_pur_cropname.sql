...
--upper group
UPDATE ca_pest.site_code SET crop = 'GRAIN_HAY'  WHERE site_sub_grp IN (24,22);
...
UPDATE ca_pest.site_code SET crop = 'OAT' WHERE site_name LIKE '%'||'OAT'||'%' AND site_name NOT LIKE '%'||'GOAT'||'%' AND site_name NOT LIKE '%'||'FLOATING'||'%' AND site_name NOT LIKE '%'||'BOAT'||'%';
...
UPDATE ca_pest.site_code SET crop = 'GRAIN_HAY'  WHERE site_name LIKE '%'||'GRAIN'||'%';
...
UPDATE ca_pest.site_code SET crop = 'CORN' WHERE site_name LIKE '%'||'CORN'||'%' AND site_name LIKE '%'||'HEN'||'%';;
...
UPDATE ca_pest.site_code SET crop = 'BEAN, CASTER' WHERE site_name LIKE '%'||'BEAN,CASTER'||'%';
UPDATE ca_pest.site_code SET crop = 'BEAN, DRY' WHERE site_name LIKE '%'||'BEAN,DRY'||'%';
...
UPDATE ca_pest.site_code SET crop = 'HOP' WHERE site_name LIKE '%'||'HOP'||'%';
...
UPDATE ca_pest.site_code SET crop = 'PEA' WHERE site_name LIKE '%'||'PEA'||'%';
...
UPDATE ca_pest.site_code SET crop = 'PEPPER' WHERE site_name LIKE '%'||'PEPPER'||'%';
...
-- DECIDUOUS
UPDATE ca_pest.site_code SET crop = 'APPLE' WHERE site_name LIKE '%'||'APPLE'||'%';
...
UPDATE ca_pest.site_code SET crop = 'PEAR' WHERE site_name LIKE '%'||'PEAR'||'%';
...
UPDATE ca_pest.site_code SET crop = 'TRUCK' WHERE site_code IN (8025,13048,8052,8025,8503,8517,16003,15043,14033,11008,11001,11000,8516,8502,28002, 28011,28024,28018,28012,28080,28061,28060,28056,28034,29123,28024,28047,28504,28013,28071,28022);
UPDATE ca_pest.site_code SET crop = 'FIELD' WHERE site_code IN (23036,29109,15010,28001,28023,28059,28049);
